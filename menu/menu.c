...
int opcaoCreditos(ALLEGRO_BITMAP *menuControles, ALLEGRO_EVENT_QUEUE *filaEventosMouse, ALLEGRO_DISPLAY *janela, ALLEGRO_BITMAP *menuInicial){
    ...
    while(!sairControles){
        ...
        al_draw_bitmap(botaoSairCreditos, al_get_bitmap_width(menuControles) - 824, al_get_bitmap_height(menuControles) - 464, 0);
        al_draw_bitmap(menuControles, 0, 0, 0);
        al_flip_display();
...
int main(void){
    ...
    ALLEGRO_BITMAP *menuInicial = NULL, *menuControles = NULL;
    ...
    menuControles = al_load_bitmap("img/jogo.png");
    if(!menuControles){
    ...
    al_set_window_title(janela, "CInlhalla");
    ...
    while(!jogar){
        ...
        switch(opcao){
            ...
            case 3: //CREDITOS
                opcaoCreditos(menuControles, filaEventosMouse, janela, menuInicial);
